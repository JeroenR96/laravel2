...
@section('body')
    <article id="mainContent">
        ...
        <p>Department chair: <strong>Gerard Montague</strong><br>
            The Animation department gives students a chance to blend the old with the new, to create unique and entertaining animated stories. From the decades old art of flipbooks, to stop motion animation and animatronics, to digital animation â€“ students in the Animation department are provided the depth and breadth needed to succeed in today&rsquo;s wildly competitive field of animation.</p>
